<template>
    <router-view
        class="z-40 h-screen w-full backdrop-filter backdrop-blur-xl"
    />
    <div class="mt-16 md:mt-20 mb-52 md:mb-60">
        ...
        >
            <div
                class="text-center bg-blue-300 dark:bg-blue-800 px-2 py-3 text-xl font-mono tracking-wider rounded-md sticky top-16 md:top-20 z-30"
            >
                {{ brand.brand }}
            </div>
